 ...
 * @author dan
 */
public class StartDatabaseBackgroundController extends SwingWorker<Boolean, String> implements LocalRequestVoidCallbackTask{
    ...
    protected Boolean doInBackground() throws Exception {
        ...
        publish("Sedang menyiapkan aplikasi...");
        Thread.sleep(2000);
        publish("Sedang mencari ketersediaan database...");
        Thread.sleep(1000);
    ...
    private void stoping() throws IOException, InterruptedException{
        ...
        String[][] command = {
            null,
            {"cmd.exe", "/c",
                "cd \"C:\\xampp\" && apache\\bin\\pv -f -k httpd.exe -q && del apache\\logs\\httpd.pid"
            },
            {"cmd.exe", "/c",
                "cd \"C:\\xampp\" && apache\\bin\\pv -f -k mysqld.exe -q && del mysql\\data\\%computername%.pid"
            }, null
        };
