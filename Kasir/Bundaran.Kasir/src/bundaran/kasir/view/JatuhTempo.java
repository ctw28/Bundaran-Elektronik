...
public final class JatuhTempo extends javax.swing.JDialog {
     ...
     * @param dataBarang
     */
    public JatuhTempo(Kasir kasir, ArrayList<ArrayList<String>> dataPembeli,
        ArrayList<ArrayList<String>> dataBarang) {
        ...
        jLabelHariIni.setText("Hari ini, "+ today());
        ...
        for (ArrayList<String> arrayList : data) {
            ...
            if (!tempo.isEmpty()) {
                if (tempo.equals(today)) {
                    ...
                    int bulanToday = Integer.parseInt(today.substring(5, 7));
                    int hariToday = Integer.parseInt(today.substring(8, 10));
    ...
    private void initComponents() {
        ...
        cetak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tokobangunan/kasir/res/print18.PNG"))); // NOI18N
        cetak.setText("Cetak   ");
        ...
        jLabel2.setText("DATA-DATA TRANSAKSI YANG BELUM LUNAS");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jLabelHariIni, javax.swing.GroupLayout.Alignment.TRAILING)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
        ...
        DataPenjualanDetailReport detail = new DataPenjualanDetailReport(colNames, paraPembeli, paraDataPembeli, kasir.dataBarang, "DATA TRANSAKSI JATUH TEMPO", false, "data_semua_jatuh_tempo_detail.pdf");
