...
public final class ProductEnt {
     ...
     * @param message 
     */
    public ProductEnt(Object objectProgress, ArrayList<Object> pairsObject, String process, String message) {
     ...
     * @param message 
     */
    public ProductEnt(Object objectProgress, List<NameValuePair> pairs, String process, String message) {
        this.objectProgress = objectProgress;
        this.pairs = pairs;
        this.process = process;
        this.message = message;
