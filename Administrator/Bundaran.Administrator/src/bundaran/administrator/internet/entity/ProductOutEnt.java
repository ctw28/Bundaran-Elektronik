 ...
 */
public final class ProductOutEnt {
     ...
     * @param message 
     */
    public ProductOutEnt(Object objectProgress, ArrayList<Object> pairsObject, String process, String message) {
     ...
     * @param message 
     */
    public ProductOutEnt(Object objectProgress, List<NameValuePair> pairs, String process, String message) {
        this.objectProgress = objectProgress;
        this.pairs = pairs;
        this.process = process;
        this.message = message;
