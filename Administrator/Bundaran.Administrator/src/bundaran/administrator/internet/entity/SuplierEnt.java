...
public class SuplierEnt {
    ...
    public SuplierEnt(Object objectProgress, ArrayList<Object> pairsObject, String process, String message) {
     ...
     * @param message 
     */
    public SuplierEnt(Object objectProgress, List<NameValuePair> pairs, String process, String message) {
        this.objectProgress = objectProgress;
        this.pairs = pairs;
        this.process = process;
        this.message = message;
    ...
    private List<NameValuePair> convertArrayListToPairs(ArrayList<Object> pairsObject){
        ...
        int i = 0;
        for (String pair : staticIdentifier.DATABASE_SEVER_STRUCTURE.TABEL_SUPLIER) {
